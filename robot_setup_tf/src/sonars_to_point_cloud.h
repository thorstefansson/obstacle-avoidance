#ifndef SONARS_TO_POINT_CLOUD_H_
#define SONARS_TO_POINT_CLOUD_H_
...
class SonarsToPointCloud
{
public:
    SonarsToPointCloud(ros::NodeHandle* nodehandle); //"main" will need to instantiate a ROS nodehandle, then pass it to the constructor
...
private:
    ...
    double range_up;
    double range_down; 
    double resolution, sonar_half_angle_width, pi;
    double x,y,z,x2,y2,z2;

    float sonar_up_offset[3], sonar_down_offset[3];   
